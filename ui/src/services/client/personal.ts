...
export const usePersonalListByTabName = (params: ListReq, tabName: string) => {
  ...
  if (tabName === 'questions') {
    params.content_type = ContentType.QUESTION;
    apiUrl = '/answer/api/v1/personal/question/page';
  }
  if (tabName === 'articles') {
    params.content_type = ContentType.ARTICLE;
    apiUrl = '/answer/api/v1/personal/question/page';
  }
  if (tabName === 'assetbuns') {
    params.content_type = ContentType.ASSETBUN;
    apiUrl = '/answer/api/v1/personal/question/page';
  }
  if (tabName === 'bounties') {
    params.content_type = ContentType.BOUNTY;
    apiUrl = '/answer/api/v1/personal/question/page';
  }
