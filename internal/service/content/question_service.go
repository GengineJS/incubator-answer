...
func (qs *QuestionService) PersonalQuestionPage(ctx context.Context, req *schema.PersonalQuestionPageReq) (
	...
	search.ContentType = req.ContentType
...
func (qs *QuestionService) SearchUserTopList(ctx context.Context, userName string, loginUserID string) ([]*schema.UserQuestionInfo, []*schema.UserAnswerInfo, error) {
	...
	search.ContentType = entity.TypeQuestion
...
// SimilarQuestion
func (qs *QuestionService) SimilarQuestion(ctx context.Context, questionID string, loginUserID string, contentType entity.QuestionType) ([]*schema.QuestionPageResp, int64, error) {
