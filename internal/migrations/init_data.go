...
var (
	...
	defaultConfigTable = []*entity.Config{
		...
		{ID: 131, Key: "rank.subject.contribute", Value: `1`},
		{ID: 132, Key: "rank.subject.score_contribute", Value: `3`},
		{ID: 133, Key: "rank.subject.accepted", Value: `2`},
		{ID: 134, Key: "rank.subject.score_accepted", Value: `5`},
		{ID: 135, Key: "rank.subject.ai_score_accepted", Value: `1`},
		{ID: 136, Key: "rank.subject.answer", Value: `1`},
		{ID: 137, Key: "rank.subject.score_answer", Value: `1`},
		{ID: 138, Key: "rank.subject.ai_answer", Value: `0`},
		{ID: 139, Key: "rank.subject.ai_score_answer", Value: `0`},
		{ID: 140, Key: "rank.subject.ai_score_get", Value: `0`},
		{ID: 141, Key: "rank.subject.ai_accepted", Value: `0`},
		{ID: 142, Key: "rank.subject.accept", Value: `1`},
		{ID: 143, Key: "rank.subject.ai_accept", Value: `0`},
		{ID: 144, Key: "rank.subject.score_accept", Value: `2`},
		{ID: 145, Key: "rank.subject.score_ai_accept", Value: `1`},
		{ID: 146, Key: "rank.subject.up_vote", Value: `4`},
		{ID: 147, Key: "rank.subject.down_vote", Value: `4`},
		{ID: 148, Key: "rank.subject.ai_up_vote", Value: `0`},
		{ID: 149, Key: "rank.subject.ai_down_vote", Value: `0`},
		{ID: 150, Key: "rank.subject.collect", Value: `2`},
		{ID: 151, Key: "rank.subject.ai_collect", Value: `0`},
	}
)
