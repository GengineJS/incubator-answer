...
const (
	TypeQuestion QuestionType = iota + 1 // 1
	TypeArticle
	TypeAssetBun
	TypeBounty
	TypeAiPic
...
type Question struct {
	...
	ContentType      int       `xorm:"not null default 1 INT(11) content_type"`
	Integral         int       `xorm:"not null default 0 INT(11) integral"`
	...
	CoverMinSize     int       `xorm:"not null default 0 INT(11) cover_min_size"`
