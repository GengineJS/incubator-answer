...
////go:embed  ../../../incubator-answer-plugins-main/connector-github/info.yaml
//var Info embed.FS
...
func (g *Connector) Info() plugin.Info {
	info := &util.Info{}
	info.SlugName = "github_connector"
	info.Type = "connector"
	info.Version = "1.2.8"
	info.Author = "answerdev"
	info.Link = "https://github.com/apache/incubator-answer-plugins/tree/main/connector-github"
	// info.GetInfo(Info)
