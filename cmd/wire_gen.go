...
func initApplication(debug bool, serverConf *conf.Server, dbConf *data.Database, cacheConf *data.CacheConf, i18nConf *translator.I18n, swaggerConf *router.SwaggerConfig, serviceConf *service_config.ServiceConfig, logConf log.Logger) (*pacman.Application, func(), error) {
	...
	questionRepo := question.NewQuestionRepo(dataData, uniqueIDRepo, configService, userRepo, notificationQueueService)
	answerRepo := answer.NewAnswerRepo(dataData, uniqueIDRepo, userRankRepo, questionRepo, configService, userRepo, notificationQueueService)
	...
	collectionRepo := collection.NewCollectionRepo(dataData, uniqueIDRepo, configService, userRankRepo, questionRepo, notificationQueueService)
	...
	answerActivityRepo := activity.NewAnswerActivityRepo(dataData, activityRepo, userRankRepo, notificationQueueService, configService)
	answerActivityService := activity2.NewAnswerActivityService(answerActivityRepo, configService, questionRepo, answerRepo)
	...
	reviewService := review2.NewReviewService(reviewRepo, objService, userCommon, userRepo, questionRepo, answerRepo, userRoleRelService, externalNotificationQueueService, tagCommonService, notificationQueueService, siteInfoCommonService, assetBunRepo)
	questionService := content.NewQuestionService(questionRepo, assetBunRepo, tagCommonService, questionCommon, userCommon, userRepo, userRoleRelService, revisionService, metaCommonService, collectionCommon, answerActivityService, emailService, notificationQueueService, externalNotificationQueueService, activityQueueService, siteInfoCommonService, externalNotificationService, reviewService, configService)
	answerService := content.NewAnswerService(answerRepo, questionRepo, assetBunRepo, questionCommon, userCommon, collectionCommon, userRepo, revisionService, answerActivityService, answerCommon, voteRepo, emailService, userRoleRelService, notificationQueueService, externalNotificationQueueService, activityQueueService, reviewService, configService)
	...
	activityActivityRepo := activity.NewActivityRepo(dataData, configService, objService)
